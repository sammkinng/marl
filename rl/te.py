...
def load_models(SIM_CFG):
        ...
        MODEL_PATH = os.path.join(LOGDIRe, "ppo_ever5.zip")
        VECNORM   = os.path.join(LOGDIRe, "vecnormalize_ever5.pkl")
        ...
        envb = DummyVecEnv([lambda: _DummyObsEnv(5, spaces.Box(
...
def bob_action_to_bb(bob_action,cfg):
    ...
    print(basis_prob,detector_gain)
...
def eval_trained_bob(
    ...
    for ep in range(n_episodes):
        ...
        # Run simulator
        info = qkd_simulation(config, aa, attacks, bb=bb)
